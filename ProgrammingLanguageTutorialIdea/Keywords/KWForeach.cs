...
namespace ProgrammingLanguageTutorialIdea.Keywords {
	...
	public class KWForeach : Keyword {
		...
		public override KeywordResult execute (Parser sender,String[] @params) {
			...
			Block foreachBlock=new Block(delegate {sender.writeJump(cMemAddr);sender.pseudoStack.pop();},0,new Byte[]{0x59,0x83,0xC4,4}/*POP ECX,ADD ESP,4*/,false,false){isLoopBlock=true,continueAddress=sender.memAddress};
			...
			if (vt.Item2!=VarType.NATIVE_ARRAY)
				throw new ParsingError("Expected var of type array, got \""+arrName+'"');
